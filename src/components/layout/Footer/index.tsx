        ...
        <div className="max-w-frame mx-auto">
          <nav className="lg:grid lg:grid-cols-12 mb-8">
            <div className="flex flex-col lg:col-span-3 lg:max-w-[248px]">
              ...
              <p className="text-foreground/70 text-sm mb-4">
                Luxbae brings together premium fragrances, air fresheners, car fresheners, and everyday essentials designed to elevate your lifestyle. We are committed to offering quality products that combine luxury, freshness, and value.
              </p>
              <p className="text-foreground/70 text-sm font-medium mb-9">
                <a href="mailto:hello@luxbae.in">hello@luxbae.in</a>
              </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-foreground/50 text-xs md:text-sm font-medium">
              Luxbae © 2024-2026. All Rights Reserved.
            </p>
